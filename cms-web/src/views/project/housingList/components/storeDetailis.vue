                ...
                <div class="stoteFrom">
                  <el-form class="form"
                    ...
                    <el-form-item prop='buildingArea'>
                      <span class="itemName"
                            :class="{'alginLeft':readonly1,'alginRight':!readonly1}">面积/m²<i class="required">*</i><span v-if="readonly1"></span></span>
                      <span v-if="readonly1"
                    ...
                    <el-form-item v-if="detailData.building.buildingBusiness==='SELF_USE'">
                      <span class="itemName"
                            :class="{'alginLeft':readonly1,'alginRight':!readonly1}">加入出租率统计<i class="required">*</i><span v-if="readonly1"></span></span>
                      <span v-if="readonly1"
                            class="itemTxt">{{detailData.onRentStatistics?'是':'否'}}</span>
                      <el-select v-model="detailData.onRentStatistics"
                                 v-else
                                 size="small"
                                 style="width:170px"
                                 placeholder="请选择">
                    ...
                    <el-form-item>
                      <span class="itemName"
                            :class="{'alginLeft':readonly1,'alginRight':!readonly1}">使用状态<span v-if="readonly1"></span></span>
                      <span class="itemTxt">{{useStatusFormat(detailData.building.buildingBusiness,detailData.onRent,detailData.onRentStatistics)}}</span>
                    </el-form-item>
  ...
  methods: {
    ...
    delRoom () {
      ...
      context.http.delete(`/cms/api/enterpriseRooms/${row.id}`).then(res => {
        ...
        if (this.tableDataEnter.length === 1) {
          this.onHide()
        }
      }).catch(error => {
        console.log(error)
