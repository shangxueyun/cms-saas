            ...
            <div class="content">
              <el-form :model="tenantDetail"
                ...
                <el-form-item prop="organizeId">
                  ...
                  <!-- <el-select v-else v-model="tenantDetail.organizeId" @change='changeOrganizeId' placeholder="请选择">
                      <el-option v-for="item in organizeOptions" :key="item.id" :label="item.name" :value="item.id">
                      </el-option>
                  </el-select> -->
                </el-form-item>
                <el-form-item prop="id">
                  ...
                  <!-- <el-select v-else v-model="tenantDetail.projectManagementDTO.id" @change='changdProject' placeholder="请选择">
                ...
                <el-form-item prop="">
                  ...
                  <!-- <el-select v-else v-model="tenantDetail.addressType" placeholder="请选择">
                        <el-option
                ...
                <el-form-item prop="">
                  ...
                  <!-- <el-input v-model="tenantDetail.address" v-else
                          maxlength="30"
                          style="width:200px"
                ...
                <el-form-item prop="">
                  ...
                  <!-- <el-input v-model="tenantDetail.investor" v-else
                          maxlength="30"
                          style="width:200px"
                          placeholder="请输入内容"></el-input> -->
                </el-form-item>
                <el-form-item prop="">
                  ...
                  <!-- <el-input v-model="tenantDetail.investorPrice"
                          type="number"
                          v-else-if ='!readOnly'
                          style="width:200px"
                          placeholder="请输入内容">
                ...
                <el-form-item prop=""
                  ...
                  <span class="txt"
                        style="margin-left: -56px">{{formatBuildingUse(tenantDetail.buildingUse)}}</span>
                  <!-- <el-select v-else v-model="tenantDetail.buildingUse" placeholder="请选择">
                        <el-option
                ...
                <el-form-item prop=""
                  ...
                  <span class="txt"
                        style="margin-left: -56px">{{formatAssetsType(tenantDetail.assetsType)}}</span>
                  <!-- <el-radio-group v-else v-model="tenantDetail.assetsType" @change='changeAssetsType'>
                ...
                <el-form-item prop="buildingArea"
                              style="width: 98%!important;"
                              v-if="tenantDetail.assetsType === 'FIELD'">
                  <div class="cttitle"
                       style="margin-left: 20px">场地面积<i class="required">*</i></div>
                  <span class="txt"
                        style="margin-left: -20px">{{tenantDetail.buildingArea}}
                    <span v-if="tenantDetail.buildingArea">㎡</span>
                  </span>
                  <!-- <el-input v-model="tenantDetail.buildingArea" 
                          v-else
                          style="width:200px"
                ...
                <el-form-item prop="buildingArea"
                              style="width: 98%!important;"
                              v-if="tenantDetail.assetsType === 'LAND'">
                  <div class="cttitle"
                       style="margin-left: 20px">土地面积<i class="required">*</i></div>
                  <span class="txt"
                        style="margin-left: -20px">{{tenantDetail.buildingArea}}
                ...
                <el-form-item prop="upArea"
                  ...
                  <!-- <el-input v-model="tenantDetail.upArea" 
                          v-else
                          style="width:200px"
                          @change="changeUpArea"
                          oninput="if(value<0)value=0"
                ...
                <el-form-item prop="upAmount"
                              v-if="tenantDetail.assetsType === 'BUILDING'">
                  <div class="cttitle"
                       style="margin-left: 20px">地上楼层<i class="required">*</i></div>
                  <span class="txt">{{tenantDetail.upAmount}}</span>
                  <!-- <el-input v-model="tenantDetail.upAmount" 
                          v-else
                          style="width:200px"
                          oninput="if(value<0)value=0"
                          type="number"
                ...
                <el-form-item prop="downArea"
                  ...
                  <!-- <el-input v-model="tenantDetail.downArea" 
                          v-else
                          style="width:200px"
                          oninput="if(value<0)value=0"
                          type="number"
                ...
                <el-form-item prop="downAmount"
                              v-if="tenantDetail.assetsType === 'BUILDING'">
                  <div class="cttitle"
                       style="margin-left: 20px">地下楼层<i class="required">*</i></div>
                  <span class="txt">{{tenantDetail.downAmount}}</span>
                  <!-- <el-input v-model="tenantDetail.downAmount" 
                          v-else
                          style="width:200px"
                          oninput="if(value<0)value=0"
                          type="number"
                ...
                <el-form-item prop=""
                              v-if="tenantDetail.assetsType === 'BUILDING'">
                  <div class="cttitle"
                       style="margin-left: 20px">竣工年份</div>
                  <span class="txt">{{tenantDetail.endWorkDate}}</span>
                  <!-- <el-date-picker
                          v-else
                          style="width: 180px"
                          v-model="tenantDetail.endWorkDate"
                          value-format="yyyy"
                          type="year"
                          placeholder="竣工年份">
                        </el-date-picker> -->
                ...
                <el-form-item prop=""
                  ...
                  <span class="txt"
                        style="margin-left: -66px">{{formateCates(tenantDetail.havaCertificates)}}</span>
                  <!-- <el-switch v-else v-model="tenantDetail.havaCertificates" @change='changeSwitch' active-text="有证" inactive-text="无证"></el-switch> -->
                </el-form-item>
                <el-form-item prop=""
                              style="width: 98%!important;"
                              v-if="tenantDetail.assetsType === 'BUILDING'">
                  ...
                  <span class="txt"
                        style="margin-left: -66px">{{tenantDetail.certificatesType}}</span>
                  <!-- <el-select v-else-if="!readOnly && tenantDetail.havaCertificates" v-model="tenantDetail.certificatesType" placeholder="请选择">
                    <el-option v-for="item in propertyOptions" :key="item.value" :label="item.value" :value="item.value">
                    </el-option>
                  </el-select>
                  <el-select v-else-if="!readOnly && !tenantDetail.havaCertificates" v-model="tenantDetail.certificatesType" placeholder="请选择">
                    <el-option v-for="item in nopropertyOptions" :key="item.value" :label="item.value" :value="item.value">
                    </el-option>
                  </el-select> -->
                </el-form-item>
                <el-form-item prop=""
                              style="width: 98%!important;"
                              v-if="tenantDetail.assetsType === 'BUILDING' && tenantDetail.havaCertificates">
                  <div class="cttitle">权利人名称</div>
                  <span class="txt"
                        style="margin-left: -66px">{{tenantDetail.obligeeName}}</span>
                  <!-- <el-input v-model="tenantDetail.obligeeName" 
                          v-else
                          style="width:200px"
                          placeholder="请输入内容"></el-input> -->
                </el-form-item>
                <el-form-item prop=""
                  ...
                  <span class="txt"
                        style="margin-left: -66px">{{tenantDetail.cqCode}}</span>
                  <!-- <el-input v-model="tenantDetail.cqCode" 
                          v-else
                          style="width:200px"
                          placeholder="请输入内容"></el-input> -->
                </el-form-item>
                <el-form-item prop=""
                              ...
                              v-if="tenantDetail.assetsType === 'BUILDING' && !tenantDetail.havaCertificates">
                  <div class="cttitle"
                       style="margin-left: 20px">建筑结构</div>
                  <span class="txt"
                        style="margin-left: -66px">{{tenantDetail.buildingStructure}}</span>
                  <!-- <el-select v-else v-model="tenantDetail.buildingStructure" placeholder="请选择">
                    <el-option v-for="item in buildingStrustOptions" :key="item.value" :label="item.value" :value="item.value">
                    </el-option>
                  </el-select> -->
                </el-form-item>
                <el-form-item prop=""
                              ...
                              v-if="tenantDetail.assetsType === 'BUILDING' && !tenantDetail.havaCertificates">
                  <div class="cttitle"
                       style="margin-left: 20px">经营方式</div>
                  <span class="txt"
                        style="margin-left: -66px">{{tenantDetail.managementMode}}</span>
                  <!-- <el-select v-else v-model="tenantDetail.managementMode" placeholder="请选择">
                    <el-option v-for="item in managementModeoptions" :key="item.value" :label="item.value" :value="item.value">
                    </el-option>
                  </el-select> -->
                </el-form-item>
                <el-form-item prop=""
                              ...
                              v-if="tenantDetail.assetsType === 'BUILDING' && !tenantDetail.havaCertificates">
                  <div class="cttitle"
                       style="margin-left: 20px">承租方式</div>
                  <span class="txt"
                        style="margin-left: -66px">{{tenantDetail.leaseMode}}</span>
                  <!-- <el-select v-else v-model="tenantDetail.leaseMode" placeholder="请选择">
                    <el-option v-for="item in managementModeoptions" :key="item.value" :label="item.value" :value="item.value">
                    </el-option>
                  </el-select> -->
                </el-form-item>
                ...
                <div class="otherShow">
                  <el-form-item prop=""
                    ...
                    <!-- <el-input v-model="tenantDetail.buildingHigh" 
                            v-else
                            oninput="if(value<0)value=0"
                            style="width:200px"
                            type="number"
                  ...
                  <el-form-item prop=""
                    ...
                    <!-- <el-input v-model="tenantDetail.boilerAmount" 
                            v-else
                            oninput="if(value<0)value=0"
                            style="width:200px"
                            type="number"
                  ...
                  <el-form-item prop=""
                    ...
                    <!-- <el-input v-model="tenantDetail.elevatorAmount" 
                            v-else
                            oninput="if(value<0)value=0"
                            style="width:200px"
                            type="number"
                  ...
                  <el-form-item prop=""
                    ...
                    <!-- <el-input v-model="tenantDetail.cargoLiftAmount" 
                            v-else
                            oninput="if(value<0)value=0"
                            style="width:200px"
                            type="number"
                  ...
                  <el-form-item prop=""
                    ...
                    <!-- <el-select v-else v-model="tenantDetail.interiorDecoration" placeholder="请选择">
                      <el-option v-for="item in trimInteriorOpions" :key="item.value" :label="item.label" :value="item.value">
                      </el-option>
                    </el-select> -->
                  </el-form-item>
                  <el-form-item prop=""
                    ...
                    <!-- <el-select v-else v-model="tenantDetail.facadeDecoration" placeholder="请选择">
                      <el-option v-for="item in decorationOptions" :key="item.value" :label="item.label" :value="item.value">
                      </el-option>
                    </el-select> -->
                  </el-form-item>
                  <span></span>
                  <el-form-item prop="">
                    ...
                    <!-- <el-input v-model="tenantDetail.sortNumber" 
                            v-else
                            style="width:200px"
                            type="number"
                            placeholder="请输入内容"></el-input> -->
                  ...
                  <el-form-item prop="">
                    ...
                    <!-- <el-select v-else v-model="tenantDetail.useStatus" placeholder="请选择">
                      <el-option v-for="item in useStatusOption" :key="item.value" :label="item.label" :value="item.value">
                      </el-option>
                    </el-select> -->
                  </el-form-item>
                </div>
