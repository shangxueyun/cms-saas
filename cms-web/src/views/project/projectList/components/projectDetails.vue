              ...
              <el-form :model="projectDetail"
                ...
                <div class="dc-right float-right">
                  ...
                  <el-form-item prop="projectCode">
                    <div class="cttitle">项目代码<i class="required">*</i></div>
          ...
          <div class="ecoIndicators"
            ...
            <el-form :model="projectDetail"
              ...
              <div v-if="!projectDetail.cycle">
                <el-form-item>
                  <div class="cttitle">总用地面积/㎡</div>
                  <span v-if="readOnly">{{projectDetail.totalLandArea}}</span>
                  <el-input v-model="projectDetail.totalLandArea"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                ...
                <el-form-item>
                  <div class="cttitle">建筑占地面积/㎡</div>
                  <span v-if="readOnly">{{projectDetail.newBuildingArea}}</span>
                  <el-input v-model="projectDetail.newBuildingArea"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  <div class="cttitle">总计容建筑面积/㎡</div>
                  <span v-if="readOnly">{{projectDetail.totalCapacityBuildingArea}}</span>
                  <el-input v-model="projectDetail.totalCapacityBuildingArea"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  ...
                  <span v-if="readOnly">{{projectDetail.totalBuildingArea}}</span>
                  <el-input v-model="projectDetail.totalBuildingArea"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  ...
                  <span v-if="readOnly">{{projectDetail.upBuildingArea}}</span>
                  <el-input v-model="projectDetail.upBuildingArea"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  ...
                  <span v-if="readOnly">{{projectDetail.downBuildingArea}}</span>
                  <el-input v-model="projectDetail.downBuildingArea"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  <div class="cttitle">建筑高度/ｍ</div>
                  <span v-if="readOnly">{{projectDetail.buildingHeight}}</span>
                  <el-input v-model="projectDetail.buildingHeight"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  <div class="cttitle">容积率</div>
                  <span v-if="readOnly">{{projectDetail.plotRatio}}</span>
                  <el-input v-model="projectDetail.plotRatio"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  <div class="cttitle">绿化率/%</div>
                  <span v-if="readOnly">{{projectDetail.greeningRate}}</span>
                  <el-input v-model="projectDetail.greeningRate"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  <div class="cttitle">汽车停车/个</div>
                  <span v-if="readOnly">{{projectDetail.parkingSpace}}</span>
                  <el-input v-model="projectDetail.parkingSpace"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  <div class="cttitle">汽车地上停车/个</div>
                  <span v-if="readOnly">{{projectDetail.upParkingSpace}}</span>
                  <el-input v-model="projectDetail.upParkingSpace"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  <div class="cttitle">汽车地下停车/个</div>
                  <span v-if="readOnly">{{projectDetail.downParkingSpace}}</span>
                  <el-input v-model="projectDetail.downParkingSpace"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <!-- <el-form-item>
                  <div class="cttitle">自行车停车/个</div>
                  <span v-if="readOnly">{{projectDetail.bikeParkingSpace}}</span>
                  <el-input v-model="projectDetail.bikeParkingSpace"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  <div class="cttitle">自行车地上停车/个</div>
                  <span v-if="readOnly">{{projectDetail.upBikeParkingSpace}}</span>
                  <el-input v-model="projectDetail.upBikeParkingSpace"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
                ...
                <el-form-item>
                  <div class="cttitle">自行车地下停车/个</div>
                  <span v-if="readOnly">{{projectDetail.downBikeParkingSpace}}</span>
                  <el-input v-model="projectDetail.downBikeParkingSpace"
                            v-else
                            maxlength="30"
                            placeholder="请输入内容"
                            type="number"></el-input>
              ...
              <div v-else>
                <div v-for="(item,index) in projectDetail.projectCycles"
                  ...
                  <el-form-item>
                    <div class="cttitle">总用地面积/㎡</div>
                    <span v-if="readOnly">{{item.totalLandArea}}</span>
                    <el-input v-model="item.totalLandArea"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
                  ...
                  <el-form-item>
                    <div class="cttitle">总计容建筑面积/㎡</div>
                    <span v-if="readOnly">{{item.totalCapacityBuildingArea}}</span>
                    <el-input v-model="item.totalCapacityBuildingArea"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
                  ...
                  <el-form-item>
                    <div class="cttitle">建筑高度/ｍ</div>
                    <span v-if="readOnly">{{item.buildingHeight}}</span>
                    <el-input v-model="item.buildingHeight"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
                  ...
                  <el-form-item>
                    <div class="cttitle">容积率</div>
                    <span v-if="readOnly">{{item.plotRatio}}</span>
                    <el-input v-model="item.plotRatio"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
                  ...
                  <el-form-item>
                    <div class="cttitle">绿化率/%</div>
                    <span v-if="readOnly">{{item.greeningRate}}</span>
                    <el-input v-model="item.greeningRate"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
                  ...
                  <el-form-item>
                    <div class="cttitle">汽车停车/个</div>
                    <span v-if="readOnly">{{item.parkingSpace}}</span>
                    <el-input v-model="item.parkingSpace"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
                  ...
                  <el-form-item>
                    <div class="cttitle">汽车地上停车/个</div>
                    <span v-if="readOnly">{{item.upParkingSpace}}</span>
                    <el-input v-model="item.upParkingSpace"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
                  ...
                  <el-form-item>
                    <div class="cttitle">汽车地下停车/个</div>
                    <span v-if="readOnly">{{item.downParkingSpace}}</span>
                    <el-input v-model="item.downParkingSpace"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
                  ...
                  <!-- <el-form-item>
                    <div class="cttitle">自行车停车/个</div>
                    <span v-if="readOnly">{{item.bikeParkingSpace}}</span>
                    <el-input v-model="item.bikeParkingSpace"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
                  ...
                  <el-form-item>
                    <div class="cttitle">自行车地上停车/个</div>
                    <span v-if="readOnly">{{item.upBikeParkingSpace}}</span>
                    <el-input v-model="item.upBikeParkingSpace"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
                  ...
                  <el-form-item>
                    <div class="cttitle">自行车地下停车/个</div>
                    <span v-if="readOnly">{{item.downBikeParkingSpace}}</span>
                    <el-input v-model="item.downBikeParkingSpace"
                              v-else
                              maxlength="30"
                              placeholder="请输入内容"
                              type="number"></el-input>
              ...
              <el-table :data="tableData"
                ...
                <el-table-column label="资料类型"
                  ...
                  <template slot-scope="scope">
                    <span v-if="!scope.row.elEdit">{{scope.row.annexNameDescription}}</span>
                ...
                <el-table-column label="资料编号"
                                 align="center">
                  <template slot-scope="scope">
                    <span v-if="!scope.row.elEdit">{{scope.row.annexNumber}}</span>
