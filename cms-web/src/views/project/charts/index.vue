        ...
        <div class="head-statistics">
          ...
          <div class="statistics-content">
            <div class="sc-item"
              ...
              <div class="item-val">
                {{projectZcObj.buildingCount}}
              </div>
            </div>
            <div class="sc-item">
              <div class="item-name">管理房源</div>
              <div class="item-val">
                {{projectZcObj.roomCount}}
              </div>
            </div>
            <div class="sc-item">
              <div class="item-name">已租房源</div>
              <div class="item-val">
                {{projectZcObj.rentRoomCount }}
              </div>
            </div>
            <div class="sc-item">
              <div class="item-name">空置房源</div>
              <div class="item-val">
                {{projectZcObj.onRentRoomCount}}
              </div>
            </div>
            <div class="sc-item">
              <div class="item-name">面积出租率</div>
              <div class="item-val">
                {{projectZcObj.rentRate | toLocaleFixed}}
                <span v-if="projectZcObj.rentRate">%</span>
              </div>
            </div>
            <div class="sc-item">
              <div class="item-name">管理房源面积m²</div>
              <div class="item-val">
                {{projectZcObj.buildingArea | toLocaleFixed}}
              </div>
            </div>
            <div class="sc-item">
              <div class="item-name">已租房源面积m²</div>
              <div class="item-val">
                {{projectZcObj.rRentAreaB | toLocaleFixed}}
              </div>
            </div>
            <div class="sc-item">
              <div class="item-name">空置房源面积m²</div>
              <div class="item-val">
                {{projectZcObj.kRentAreaB | toLocaleFixed}}
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            <div>
              <div>
                <i class="sign gray"></i>
                <div>
                  <span>空置房源</span><span>{{floorData.statisics.noRentCount}}/{{floorData.statisics.noRentBuildingAreaSum}}m²</span>
                </div>
              </div>
              <div>
                <i class="sign green"></i>
                <div>
                  <span>已租房源</span><span>{{floorData.statisics.isRentContractCount}}/{{floorData.statisics.isRentBuildingAreaSum}}m²</span>
                </div>
              </div>
            </div>
            <div>
              <div>
                <i class="sign "></i>
                <div>
                  <span>全部房源</span><span>{{floorData.statisics.count}}/{{floorData.statisics.buildingAreaSum}}m²</span>
                </div>
              </div>
              <div>
                <i class="sign "></i>
                <div>
                  <span>出租率</span><span>{{floorData.statisics.lettingRate}}%</span>
                </div>
              </div>
            </div>
          </div>
