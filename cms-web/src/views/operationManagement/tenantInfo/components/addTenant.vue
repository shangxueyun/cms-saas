      ...
      <el-form :model="addData"
        ...
        <div class="dc-right">
          ...
          <el-form-item style="margin-bottom: 20px;">
            ...
            <el-select v-model="addData.tenantUse"
          ...
          <el-form-item prop="referred"
                        v-if="addData.tenantUse==='SHOP'||addData.tenantUse==='MARKET'"
                        style="margin-bottom: 20px;">
          ...
          <el-form-item v-if="addData.tenantUse==='SHOP'||addData.tenantUse==='MARKET'"
                        style="width:100%">
            <span>店铺logo</span>
            <div style="display: flex;margin-top:10px;">
              <div v-if="addData.shopPhotos"
                   class="shopPhotos">
                <img :src="addData.shopPhotos">
                <i @click="deleFile()"
              ...
              <aliUpload class="aliUpload deviceDetails"
                         ...
                         :iconImg="iconImg"
                         :uploadIcon="true"
                         @setAnnex="(annexURL, annexName)=>{setAnnex(annexURL, annexName)}" />
            </div>
          </el-form-item>
        </div>
      </el-form>
...
export default {
  ...
  methods: {
    deleFile () {
      this.addData.shopPhotos = ''
    },
    setAnnex (annexURL, annexName) {
      this.addData.shopPhotos = annexURL
    },
    tenantUseChange (val) {
      if (val === 'WORK') {
        this.addData.tenantUse = 'WORK'
        this.addData.industryId = ''
        this.addData.shopPhotos = ''
      }
      if (val === 'SHOP') {
        this.industry('业态')
