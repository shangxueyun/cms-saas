<template>
    <div id="businessActivities" class="projectActivities businessActivities">
      <span class="page_head_title">企划活动</span>
      <ul class="default_tab_block">
        <li @click="toProjectActivitiess" v-if="hasAuthority('02030401')">
          <span>项目活动</span>
        </li>
        <li class="active" v-if="hasAuthority('02030402')">
          <span>商家活动</span>
        </li>
      </ul>
      <div class="search-bar">
        <div class="searbar-left">
          <span>
            <el-select v-model="projectManagementId" placeholder="选择项目" style="width:150px" clearable size="small">
              <el-option
        ...
        <el-button class="tban tban1"
                        @click="addActivity" v-if="hasAuthority('02030404')"><i class="iconfont icon-crm_xinzeng-"></i> 新增活动</el-button>
      </div>
      <div class="tableList">
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column label="操作"  width="300px" align="center" v-if="hasAuthority('02030406')">
            <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    async query () {
      ...
      let result = await context.http.get('/cms/api/plan-activities/shop', param)
