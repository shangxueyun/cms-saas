      ...
      <div class="newlystep2"
        ...
        <div class="dl-content clearfix">
          <div class="dc-right float-right"
            ...
            <div class="dr-head contract-rules"><span class="vertical"></span>标题</div>
            <div class="other-info"
                 style="min-height:60px;padding:14px;color:#666"> <span>{{approvalInfo.title}}</span></div>
          </div>
          <div class="dc-right float-right"
               style="width: 100%;margin-top:20px">
            <div class="dr-head contract-rules"><span class="vertical"></span>正文</div>
            <div class="other-info"
          ...
          <div class="dc-right float-right"
               style="width: 100%">
            <div class="enclosure">
              <div class="dr-head contract-rules"><span class="vertical"></span>发起人附件</div>
          ...
          <div class="dc-right float-right"
            ...
            <div class="dr-head"
              ...
              审批记录
              <span @click="showRecord = !showRecord" style="cursor: pointer;">
                <i class="iconfont icon-right" :class="{'icon-bottom': showRecord}"></i>
              </span>
            </div>
          ...
          <div class="dc-right float-right"
            ...
            <div class="dr-head contract-rules"><span class="vertical"></span>审批撤回原因</div>
            <div class="textArea"
          ...
          <div class="dc-right float-right"
            ...
            <div class="dr-head contract-rules"><span class="vertical"></span>审批意见</div>
            <div class="textArea"
                 style="background-color:#ffffff">
              <el-input type="textarea"
                        :rows="4"
          ...
          <div class="dc-right float-right"
               ...
               v-if="approvalOperation">
            <div class="enclosure">
              <div class="dr-head attachment"><span class="vertical"></span>我的附件
                <div class="upload">
                  上传附件
                  <input type="file"
          ...
          <div class="dc-right float-right"
               ...
               v-if="approvalOperation">
            <div class="dr-head"
                 style="margin-bottom: 0"><span class="vertical"></span>临时抄送人
