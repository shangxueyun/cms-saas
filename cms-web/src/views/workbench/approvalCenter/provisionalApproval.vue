  ...
  <div class="provisional-approval-process">
    ...
    <div class="basics-design" v-if="basicsDesign">
      <el-form :model="addData" :rules="rules" ref="ruleForm">
        ...
        <el-form-item label="组织" class="notrequired">
          <!-- <el-select
...
export default {
  ...
  methods: {
    ...
    handleChange1 () {
      this.addData.currencyForm.organizeId = this.organizeId[this.organizeId.length - 1]
      this.$nextTick(() => {
        this.addData.currencyForm.organizeName = this.$refs['cascaderAddr'].presentText
      })
    },
    queryProcess (id) {
