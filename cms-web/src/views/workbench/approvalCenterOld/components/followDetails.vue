    ...
    <drawer class="drawer_new"
      ...
      <div class="details_content drawer-body"
        ...
        <div class="main_content timeline_content "
          ...
          <div class="followBtn">
            <el-button @click="dialogVisible = true;queryOrganizeList()"
                       class="follow"
                       size="small">写跟进</el-button>
          </div>
      ...
      <div>
        <el-form :model="ruleForm"
          ...
          <el-form-item>
            ...
            <span class="sendIfo" :class="{'red': !ruleForm.send}">不发送</span>
            ...
            <span class="sendIfo" :class="{'blue': ruleForm.send}">发送</span>
          </el-form-item>
