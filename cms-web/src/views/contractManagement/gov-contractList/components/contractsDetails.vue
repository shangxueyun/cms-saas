  ...
  <div class="contracts-info contracts-details contracts-info3">
    <drawer :show="detailsdrawershow"
      ...
      <div class="mainlayout"
           style="width: 750px;background-color: #fff;padding-bottom: 50px;"
           slot="drawer">
              ...
              <el-form :model="contractDetails"
                ...
                <div class="step1"
                  ...
                  <div class="dc-right float-right tenantinfo conDetail">
                    ...
                    <div style="margin-left: 15px;width: 720px!important">
                      <el-table :data="contractDetails.buildings"
                                style="width: 100%">
                        ...
                        <el-table-column label="楼宇类型"
                          ...
                          <template slot-scope="scope">
                            {{assetsTypeFormte(scope.row.assetsType)}}
                          </template>
                        </el-table-column>
                        ...
                        <el-table-column label="租赁面积"
                                         align="center">
                          <template slot-scope="scope">
                            {{scope.row.leaseArea}} {{scope.row.assetsType === 'LAND' ? '亩' : '㎡'}}
                          </template>
                        </el-table-column>
                      </el-table>
                    </div>
                  ...
                  <div class="dc-right float-right tenantinfo conDetail">
                    <div class="dr-head btn-wrap">
                      <span class="vertical"></span>租赁方式
                    </div>
                    <el-form-item :label-width="formLabelWidth"
                                  style="margin-bottom: 20px;width: 100px!important;">
                      <div class="cttitle">租赁方式<i class="required">*</i></div>
                      <span>
                        <!-- {{contractDetails.contractType === 'RENT' ? '一手租赁' : contractDetails.contractType === 'SUBLET' ? '转租' : ''}} -->
                        {{contractTypeFormat(contractDetails.parents)}}
                      </span>
                    </el-form-item>
                    <el-form-item style="margin-bottom: 20px;width: 80%!important;"
                  ...
                  <div class="dc-right float-right tenantinfo conDetail">
                    ...
                    <el-form-item class="project-box"
                                  ...
                                  style="margin-bottom: 20px;margin-top: 0;width:720px!important;">
                      <div class="annexes">
                    ...
                    <div class="selected-housing bill-details">
                      ...
                      <ul v-for="(item, index) in contractRulesData"
                        ...
                        <li class="operation-li"
                          ...
                          <span v-if="hasAuthority('02020510') && contractDetails.contractStatus !== 'ZH_APPROVAL' && contractDetails.contractStatus !== 'NO' && contractDetails.contractStatus !== 'XQ_APPROVAL' && contractDetails.contractType === 'RENT'"
    ...
    <el-drawer title="规则详情"
               size="770px"
               class="rentRulesDialog"
...
export default {
  ...
  methods: {
    ...
    rulesDetail (termType, id) {
      context.http.get(`/cms/api/rent-clauses/${id}`, {
        contractId: this.detailData.id
      }).then(res => {
        if (res.status === 200) {
    ...
    previewBills () {
      ...
      context.http.get(`/cms/api/rent-clauses/business/${this.ruleId}?startDate=${this.billStart[0]}&endDate=${this.billStart[1]}&contractId=${this.detailData.id}`).then(res => {
        if (res.status === 200) {
    ...
    cretaedBills () {
      ...
      context.http.post(`/cms/api/rent-clauses/business/${this.ruleId}?startDate=${this.billStart[0]}&endDate=${this.billStart[1]}&contractId=${this.detailData.id}`).then(res => {
        if (res.status === 200) {
          this.$message({
            message: '生成成功',
            type: 'success'
